...
<head>
    ...
    body {
        ...
        margin: 0;
        overflow: hidden;
        background: linear - gradient(45 deg, var (--bg - gradient - start), var (--bg - gradient - end));
    ...
    .login - container {
        ...
        border - radius: 20 px;
        box - shadow: 0 8 px 32 px 0 var (--shadow - color);
    ...
    .form - group input: focus {
        ...
        box - shadow: 0 0 0 4 px rgba(0, 122, 255, 0.2);
    }
