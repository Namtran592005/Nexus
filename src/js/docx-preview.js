...
`;
    ...
    renderMmlDelimiter(elem) {
      ...
      children.push(
        this.createElementNS(ns.mathML, "mo", null, [elem.props.endChar ?? ")"])
      );
    ...
    renderMmlNary(elem) {
      ...
      if (supElem || subElem) {
        ...
        children.push(
          this.createElementNS(ns.mathML, "mover", null, [charElem, supElem])
        );
      } else if (subElem) {
        children.push(
          this.createElementNS(ns.mathML, "munder", null, [charElem, subElem])
        );
      } else {
